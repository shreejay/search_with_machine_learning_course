...
#print(os.getcwd())
logging.basicConfig(filename='logs/bulk_indexing.log',filemode='a',format='%(levelname)s:%(message)s')
...
def main(source_dir):
    ...
    print(f'Done. Total docs: {docs_indexed} in {str(process_time)} seconds')
if __name__ == "__main__":
    src_dir=r'C:\Users\snair\Documents\Repos\search_with_machine_learning_course\NotesAndDataDoNotCheckIn\data\acm-sf-chapter-hackathon-big\product_data\product_data\products'
    main(src_dir)
